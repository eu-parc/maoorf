# Contributing to maoorf

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
maoorf. These guidelines are not strict rules.
...
The maoorf team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the maoorf technical leads
...
[issues]: https://github.com/eu-parc/maoorf/issues/
[pulls]: https://github.com/eu-parc/maoorf/pulls/
